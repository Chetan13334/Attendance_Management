          ...
          <div className="flex justify-between gap-4 p-1 border-t border-gray-200 bg-white flex-shrink-0">
            ...
            <div className="flex gap-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="px-6 py-3 rounded-lg bg-indigo-600 text-white font-semibold hover:bg-indigo-700 shadow-lg shadow-indigo-300/50 transition duration-150 disabled:bg-indigo-300 disabled:cursor-not-allowed"
              >
