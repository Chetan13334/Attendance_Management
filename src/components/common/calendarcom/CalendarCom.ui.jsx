        ...
        <div className="w-8 h-8 p-[1px] rounded-full bg-gradient-to-br from-yellow-300 to-red-500 shadow-md 
          ...
          {birthday.Photo ? (
            <img
              ...
              onError={(e) => { e.target.onerror = null; e.target.src = "https://placehold.co/40x40/fbcfe8/000?text=P"; }}
            />
          ) : (
            <div className="w-full h-full rounded-full flex items-center justify-center bg-pink-200 text-pink-700 font-bold text-xs border-2 border-white">
              {birthday.Name ? birthday.Name.charAt(0).toUpperCase() : "B"}
            </div>
          )}
        </div>
      </div>
              ...
              <div className="relative flex-shrink-0">
                <div className="w-7 h-7 p-[1px] rounded-full bg-gradient-to-br from-yellow-300 via-orange-400 to-red-500 shadow-md">
                  {birthday.Photo ? (
                    ...
                    <div className="w-full h-full rounded-full flex items-center justify-center bg-pink-200 text-pink-700 font-bold text-[10px] border border-white">
                      {birthday.Name ? birthday.Name.charAt(0).toUpperCase() : "B"}
                    </div>
                  )}
                </div>
                  ...
                  {week.map((date, di) => {
                    ...
                    return (
                      <td
                        ...
                        className={`border border-gray-200 p-1 h-32 sm:h-40 cursor-pointer align-top relative ${isToday
                          ...
                          <div className="flex flex-col h-full" style={{ overflow: "visible" }}>
                            ...
                            <div className="flex-grow mt-1 overflow-y-auto flex flex-col gap-2 px-1" style={{ overflowX: "visible" }}>
                              ...
                              {dayEvents.map((ev) => (
                                <div
                                  key={ev.id}
                                  className={`relative group rounded-lg p-2.5 text-xs font-medium cursor-pointer
                                    transition-shadow duration-200 ease-in-out
                                    ${ev.event_theme === "blue"
                                      ? "bg-blue-400 text-white shadow-sm hover:shadow-md"
                                      : ev.event_theme === "red"
                                        ? "bg-red-400 text-white shadow-sm hover:shadow-md"
                                        : ev.event_theme === "yellow"
                                          ? "bg-yellow-400 text-gray-800 shadow-sm hover:shadow-md"
                                          : ev.event_theme === "green"
                                            ? "bg-green-400 text-white shadow-sm hover:shadow-md"
                                            : "bg-purple-400 text-white shadow-sm hover:shadow-md"
                                    }`}
                                >
                                  ...
                                  <button
                                    ...
                                    className="absolute top-1.5 right-1.5 w-5 h-5 rounded-full bg-white/30 backdrop-blur-sm
